...
| 빅 데이터에 최적화 | 아니요 | 아니오 | 아니요 | 예 <sup>1</sup> | 예 <sup>2</sup> |
| 관계형 데이터베이스로 복사 | 아니오 | 아니요 | 아니요 | 아니요 | 예 | 
| 관계형 데이터베이스에서 복사 | 아니요 | 아니요 | 아니요 | 아니요 | 예 | 
| Blob 저장소로 복사 | 예 | 예 | 예 | 아니요 | 예 | 
| Blob 저장소에서 복사 | 예 | 예 | 예 | 예 | 예 |
| Data Lake Store로 복사 | 아니오 | 아니오 | 예 | 예 |  예 | 
...
| 관계형 데이터베이스로 복사 | 아니요 | 아니오 | 예 |
| Blob 저장소로 복사 | 예 | 아니요 | 예 |
| Blob 저장소에서 복사 | 예 | 아니요 | 예 |
| Data Lake Store로 복사 | 아니오 | 아니오 | 예 |
| Data Lake Store에서 복사 | 아니요 | 아니오 | 예 |
| Blob 저장소로 업로드 | 예 | 예 | 예 |
