...
<span data-ttu-id="9b6d5-130">구독에는 세 가지 유형의 관리자 계정이 할당됩니다.</span><span class="sxs-lookup"><span data-stu-id="9b6d5-130">Subscriptions are assigned three types of administrator accounts:</span></span>
...
-   [<span data-ttu-id="9b6d5-145">Azure 관리자 역할을 추가 또는 변경하는 방법</span><span class="sxs-lookup"><span data-stu-id="9b6d5-145">How to add or change Azure administrator roles</span></span>](https://azure.microsoft.com/documentation/articles/billing-add-change-azure-subscription-administrator/)
...
### <a name="management-interfaces"></a><span data-ttu-id="9b6d5-159">관리 인터페이스</span><span class="sxs-lookup"><span data-stu-id="9b6d5-159">Management interfaces</span></span>
...
### <a name="paired-regions"></a><span data-ttu-id="9b6d5-227">쌍을 이루는 지역</span><span class="sxs-lookup"><span data-stu-id="9b6d5-227">Paired regions</span></span>
...
-   [<span data-ttu-id="9b6d5-241">Azure에서 Linux 가상 머신에 대한 계획된 유지 관리</span><span class="sxs-lookup"><span data-stu-id="9b6d5-241">Planned maintenance for Linux virtual machines in Azure</span></span>](https://azure.microsoft.com/documentation/articles/virtual-machines-linux-planned-maintenance/)
...
<span data-ttu-id="9b6d5-254">초 단위로 요금이 청구되는 AWS와는 달리, Azure 주문형 VM은 분 단위로 요금이 청구됩니다.</span><span class="sxs-lookup"><span data-stu-id="9b6d5-254">Unlike AWS' per second billing, Azure on-demand VMs are billed by the minute.</span></span>
...
#### <a name="see-also"></a><span data-ttu-id="9b6d5-278">참고 항목</span><span class="sxs-lookup"><span data-stu-id="9b6d5-278">See also</span></span>
...
-   <span data-ttu-id="9b6d5-292">[Blob Storage](https://azure.microsoft.com/documentation/articles/storage-create-storage-account/) - 문서, 미디어 파일 또는 응용 프로그램 설치 프로그램과 같은 모든 종류의 텍스트 또는 이진 데이터를 저장할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="9b6d5-292">[Blob storage](https://azure.microsoft.com/documentation/articles/storage-create-storage-account/) - stores any type of text or binary data, such as a document, media file, or application installer.</span></span> <span data-ttu-id="9b6d5-293">개인 액세스에 대해 Blob Storage를 설정하거나 인터넷에 공개적으로 콘텐츠를 공유할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="9b6d5-293">You can set Blob storage for private access or share contents publicly to the Internet.</span></span> <span data-ttu-id="9b6d5-294">Blob Storage는 AWS S3 및 EBS와 동일한 용도로 사용됩니다.</span><span class="sxs-lookup"><span data-stu-id="9b6d5-294">Blob storage serves the same purpose as both AWS S3 and EBS.</span></span>
...
#### <a name="see-also"></a><span data-ttu-id="9b6d5-306">참고 항목</span><span class="sxs-lookup"><span data-stu-id="9b6d5-306">See also</span></span>
...
-   <span data-ttu-id="9b6d5-319">[Azure DNS](https://azure.microsoft.com/documentation/services/dns/)는 도메인 및 DNS 관리를 제공합니다.</span><span class="sxs-lookup"><span data-stu-id="9b6d5-319">[Azure DNS](https://azure.microsoft.com/documentation/services/dns/) provides domain and DNS management.</span></span>
...
-   [<span data-ttu-id="9b6d5-332">SQL Database</span><span class="sxs-lookup"><span data-stu-id="9b6d5-332">SQL Database</span></span>](https://docs.microsoft.com/azure/sql-database/sql-database-technical-overview)
...
<span data-ttu-id="9b6d5-345">Azure는 디렉터리 서비스를 다음과 같은 제품으로 나눠 놓았습니다.</span><span class="sxs-lookup"><span data-stu-id="9b6d5-345">Azure splits up directory services into the following offerings:</span></span>
...
### <a name="application-and-messaging-services"></a><span data-ttu-id="9b6d5-355">응용 프로그램 및 메시지 서비스</span><span class="sxs-lookup"><span data-stu-id="9b6d5-355">Application and messaging services</span></span>
...
-   <span data-ttu-id="9b6d5-380">[Stream Analytics](https://azure.microsoft.com/documentation/services/stream-analytics/) - 실시간으로 데이터를 분석합니다.</span><span class="sxs-lookup"><span data-stu-id="9b6d5-380">[Stream Analytics](https://azure.microsoft.com/documentation/services/stream-analytics/) - real-time data analysis.</span></span>
...
-   [<span data-ttu-id="9b6d5-389">Azure IoT Hub 시작</span><span class="sxs-lookup"><span data-stu-id="9b6d5-389">Get started with Azure IoT Hub</span></span>](https://azure.microsoft.com/documentation/articles/iot-hub-csharp-csharp-getstarted/)

-   [<span data-ttu-id="9b6d5-390">IoT Hub 및 Event Hubs의 비교</span><span class="sxs-lookup"><span data-stu-id="9b6d5-390">Comparison of IoT Hub and Event Hubs</span></span>](https://azure.microsoft.com/documentation/articles/iot-hub-compare-event-hubs/)

### <a name="mobile-services"></a><span data-ttu-id="9b6d5-391">모바일 서비스</span><span class="sxs-lookup"><span data-stu-id="9b6d5-391">Mobile services</span></span>

#### <a name="notifications"></a><span data-ttu-id="9b6d5-392">공지</span><span class="sxs-lookup"><span data-stu-id="9b6d5-392">Notifications</span></span>

<span data-ttu-id="9b6d5-393">Notification Hubs는 SMS 또는 전자 메일 메시지 보내기를 지원하지 않으므로 이러한 기능을 제공하는 타사 서비스가 필요합니다.</span><span class="sxs-lookup"><span data-stu-id="9b6d5-393">Notification Hubs do not support sending SMS or email messages, so third-party services are needed for those delivery types.</span></span>

#### <a name="see-also"></a><span data-ttu-id="9b6d5-394">참고 항목</span><span class="sxs-lookup"><span data-stu-id="9b6d5-394">See also</span></span>

-   [<span data-ttu-id="9b6d5-395">Android 앱 만들기</span><span class="sxs-lookup"><span data-stu-id="9b6d5-395">Create an Android app</span></span>](https://azure.microsoft.com/documentation/articles/app-service-mobile-android-get-started/)

-   [<span data-ttu-id="9b6d5-396">Azure Mobile Apps의 인증 및 권한 부여</span><span class="sxs-lookup"><span data-stu-id="9b6d5-396">Authentication and Authorization in Azure Mobile Apps</span></span>](https://azure.microsoft.com/documentation/articles/app-service-mobile-auth/)

-   [<span data-ttu-id="9b6d5-397">Azure Notification Hubs를 사용하여 푸시 알림 보내기</span><span class="sxs-lookup"><span data-stu-id="9b6d5-397">Sending push notifications with Azure Notification Hubs</span></span>](https://azure.microsoft.com/documentation/articles/notification-hubs-android-push-notification-google-fcm-get-started/)

### <a name="management-and-monitoring"></a><span data-ttu-id="9b6d5-398">관리 및 모니터링</span><span class="sxs-lookup"><span data-stu-id="9b6d5-398">Management and monitoring</span></span>

#### <a name="see-also"></a><span data-ttu-id="9b6d5-399">참고 항목</span><span class="sxs-lookup"><span data-stu-id="9b6d5-399">See also</span></span>
-   [<span data-ttu-id="9b6d5-400">모니터링 및 진단 지침</span><span class="sxs-lookup"><span data-stu-id="9b6d5-400">Monitoring and diagnostics guidance</span></span>](https://azure.microsoft.com/documentation/articles/best-practices-monitoring/)

-   [<span data-ttu-id="9b6d5-401">Azure Resource Manager 템플릿 생성 모범 사례</span><span class="sxs-lookup"><span data-stu-id="9b6d5-401">Best practices for creating Azure Resource Manager templates</span></span>](https://azure.microsoft.com/documentation/articles/resource-manager-template-best-practices/)

-   [<span data-ttu-id="9b6d5-402">Azure Resource Manager 빠른 시작 템플릿</span><span class="sxs-lookup"><span data-stu-id="9b6d5-402">Azure Resource Manager Quickstart templates</span></span>](https://azure.microsoft.com/documentation/templates/)


## <a name="next-steps"></a><span data-ttu-id="9b6d5-403">다음 단계</span><span class="sxs-lookup"><span data-stu-id="9b6d5-403">Next steps</span></span>

-   [<span data-ttu-id="9b6d5-404">AWS와 Azure의 전체 서비스 비교표</span><span class="sxs-lookup"><span data-stu-id="9b6d5-404">Complete AWS and Azure service comparison matrix</span></span>](https://aka.ms/azure4aws-services)

-   [<span data-ttu-id="9b6d5-405">대화형 Azure 플랫폼 큰 그림</span><span class="sxs-lookup"><span data-stu-id="9b6d5-405">Interactive Azure Platform Big Picture</span></span>](http://azureplatform.azurewebsites.net/)

-   [<span data-ttu-id="9b6d5-406">Azure 시작</span><span class="sxs-lookup"><span data-stu-id="9b6d5-406">Get started with Azure</span></span>](https://azure.microsoft.com/get-started/)

-   [<span data-ttu-id="9b6d5-407">Azure 솔루션 아키텍처</span><span class="sxs-lookup"><span data-stu-id="9b6d5-407">Azure solution architectures</span></span>](https://azure.microsoft.com/solutions/architecture/)

-   [<span data-ttu-id="9b6d5-408">Azure 참조 아키텍처</span><span class="sxs-lookup"><span data-stu-id="9b6d5-408">Azure Reference Architectures</span></span>](https://azure.microsoft.com/documentation/articles/guidance-architecture/)

-   [<span data-ttu-id="9b6d5-409">패턴 및 연습: Azure 지침</span><span class="sxs-lookup"><span data-stu-id="9b6d5-409">Patterns & Practices: Azure Guidance</span></span>](https://azure.microsoft.com/documentation/articles/guidance/)

-   [<span data-ttu-id="9b6d5-410">무료 온라인 강좌: AWS 전문가를 위한 Microsoft Azure</span><span class="sxs-lookup"><span data-stu-id="9b6d5-410">Free Online Course: Microsoft Azure for AWS Experts</span></span>](http://aka.ms/azureforaws)
