...
* **Azure 부하 분산 장치**. [부하 분산 장치](https://docs.microsoft.com/en-us/azure/load-balancer/load-balancer-get-started-internet-arm-cli)는 들어오는 인터넷 요청을 VM 인스턴스들로 분산시킵니다. 부하 분산 장치는 일부 관련 리소스들을 포함합니다.
