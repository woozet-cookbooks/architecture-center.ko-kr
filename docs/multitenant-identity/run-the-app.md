...
2. **새로 만들기** > **보안 + ID** > **Azure Active Directory**를 클릭합니다.
...
1.  [Azure Portal](https://portal.azure.com)로 이동하여 **새로 만들기** > **데이터베이스** > **Redis Cache**를 클릭합니다.

2.  DNS 이름, 리소스 그룹, 위치 및 가격 책정 계층을 포함하여 필수 정보를 입력합니다. 새 리소스 그룹을 만들거나 기존 리소스 그룹을 사용할 수 있습니다.

3. **만들기**를 클릭합니다.

4. Redis Cache를 만든 후 포털의 리소스로 이동합니다.
